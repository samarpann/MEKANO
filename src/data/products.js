export const categories = [
    {
        ...
        products: [
            ...
            { id: 32, name: "Bronze Fusible Plug", sub: "Safety Valves", image: "/assets/products/Bronze Fusible Plug.jpg.jpeg", description: "Safety device for boilers and pressure vessels." },
            { id: 33, name: "Bronze Safety Valve", sub: "Safety Valves", image: "/assets/products/Bronze Safety Valve.jpg.jpeg", description: "High-quality Bronze Safety Relief Valve for steam and air." },
            { id: 34, name: "C.I. T Strainer", sub: "Strainers", image: "/assets/products/C.I. T Strainer.jpg.jpeg", description: "Large-capacity T-Type Strainer for main pipelines." },
            ...
            { id: 37, name: "Cast Iron Vertical Inverted Steam Trap", sub: "Steam Traps", image: "/assets/products/Cast Iron Vertical Inverted Steam Trap.jpg.jpeg", description: "Inverted Bucket Steam Trap for efficient condensate removal." },
            ...
            { id: 39, name: "Cast Iron Y Type Strainer", sub: "Strainers", image: "/assets/products/Cast Iron Y Type Strainer.jpg.jpeg", description: "Standard Cast Iron Y-Strainer for fluid filtration." },
            { id: 40, name: "Cast Steel Ball Valve", sub: "Ball Valves", image: "/assets/products/Cast Steel Ball Valve.jpg.jpeg", description: "High-pressure Cast Steel Ball Valve for demanding applications." },
            { id: 41, name: "Cast Steel Globe Valve", sub: "Globe Valves", image: "/assets/products/Cast Steel Globe Valve.jpg.jpeg", description: "Precision Cast Steel Globe Valve for throttling." },
            { id: 42, name: "Cast Steel Parallel Slide Blow off Valve", sub: "Globe Valves", image: "/assets/products/Cast Steel Parallel Slide Blow off Valve.jpg.jpeg", description: "High-pressure slide valve for boiler blow-off." },
            { id: 43, name: "Cast Steel Swing Check Valve", sub: "Check Valves", image: "/assets/products/Cast Steel Swing Check Valve.jpg.jpeg", description: "Robust Cast Steel Check Valve for high-temperature service." },
            { id: 44, name: "Cast Steel Y-Type Strainer", sub: "Strainers", image: "/assets/products/Cast Steel Y-Type Strainer.jpg.jpeg", description: "High-pressure Strainer for protecting downstream equipment." },
    ...
    },
    {
        ...
        products: [
            { id: 9, name: "Jindal Hisar GI Pipe", sub: "GI Pipes", image: "https://mekanoengineers.netlify.app/assets/products/galvanized-iron-pipe-500x500.jpg", description: "High-quality galvanized iron pipes from Jindal Hisar." },
            { id: 50, name: "Jindal Star CS Seamless Pipe", sub: "CS Pipes", image: "https://mekanoengineers.netlify.app/assets/products/cs-pipe-fittings-500x500.jpg", description: "Seamless carbon steel pipes for high-pressure service." },
            ...
            { id: 11, name: "SORF Flanges", sub: "Flanges", image: "/assets/products/Flanges SORF.jpeg", description: "Slip-On Raised Face Flanges for secure pipe connections." },
            { id: 51, name: "Weld Neck Flanges", sub: "Flanges", image: "/assets/products/Weldneck  Flanges.jpeg", description: "Robust Weldneck Flanges for severe service conditions." },
            { id: 52, name: "Forged Pipe Fittings", sub: "Fittings", image: "/assets/products/Forged Pipe Fittings ( IBR & Non IBR).avif", description: "IBR and Non-IBR Forged Fittings for high-pressure piping." },
        ]
    },
    {
        id: "pneumatic-solutions",
        name: "Pneumatic Solutions",
        subCategories: ["All", "FRL Units", "Fittings", "Pipes", "Cylinders"],
        description: "Authorised dealers of FESTO & SMC pneumatic automation components.",
        products: [
            { id: 12, name: "FESTO DSBC Pneumatic Cylinder", sub: "Cylinders", image: "https://mekanoengineers.netlify.app/assets/products/festo-pneumatic-cylinder-500x500.jpg", description: "FESTO standard pneumatic cylinder for automation." },
            { id: 53, name: "Camozzi Compact Cylinder", sub: "Cylinders", image: "https://mekanoengineers.netlify.app/assets/products/festo-frl-unit-500x500.jpg", description: "Compact pneumatic cylinder for limited space applications." },
            { id: 13, name: "PU Fittings", sub: "Fittings", image: "/assets/products/PU Fittings.jpeg", description: "Quick-connect Polyurethane Fittings for pneumatic lines." },
            { id: 54, name: "PU Pipes", sub: "Pipes", image: "/assets/products/PU Pipes.jpeg", description: "Flexible Polyurethane Tubing for pneumatic systems." },
    ...
    },
    {
        ...
        products: [
            ...
            { id: 17, name: "Spiral Wound Gasket", sub: "Gaskets", image: "/assets/products/Spiral Wound Gasket.png", description: "High-performance spiral wound gasket." },
            { id: 18, name: "PTFE Tape", sub: "Tape", image: "/assets/products/PTFE Tape.jpeg", description: "Thread sealing tape." },
            { id: 60, name: "Asbestos Gaskets", sub: "Gaskets", image: "/assets/products/Asbestos Gaskets.jpg.jpeg", description: "Traditional asbestos gaskets for high heat." },
            { id: 61, name: "Asbestos Rope", sub: "Ropes & Yarn", image: "/assets/products/Asbestos Rope.jpeg", description: "Heat-resistant asbestos rope." },
            { id: 62, name: "Asbestos Tape", sub: "Tape", image: "/assets/products/Asbestos Tape(Textile).jpg.jpeg", description: "Textile asbestos tape." },
            { id: 63, name: "Asbestos Yarn", sub: "Ropes & Yarn", image: "/assets/products/Asbestos Yarn.jpeg", description: "Industrial asbestos yarn." },
            { id: 64, name: "Gland Packing", sub: "Packing", image: "/assets/products/Gland Packing_.jpg.jpeg", description: "Standard gland packing." },
            { id: 65, name: "Jointings", sub: "Gaskets", image: "/assets/products/Jointings.png", description: "Industrial jointing solutions." },
            { id: 66, name: "PTFE Gland Packing Black", sub: "Packing", image: "/assets/products/PTFE Gland Packing Black.png", description: "Graphited PTFE packing." },
            { id: 67, name: "PTFE Gland Packing White", sub: "Packing", image: "/assets/products/PTFE Gland Packing.png", description: "Pure white PTFE packing." },
        ]
    },
    {
    ...
    },
    {
        ...
        products: [
            ...
            { id: 73, name: "Motors -Double Phase", sub: "Single Phase", image: "/assets/products/Motors -Double Phase.webp", description: "Specialized double-phase motor." },
        ]
    },
    {
        id: "flexible-hose-pipes",
        name: "Flexible Hose Pipes",
        subCategories: ["All", "Flexible Pipes"],
    ...
    },
    {
        id: "gearboxes",
        name: "Gearboxes",
        subCategories: ["All", "Gears", "Geared Motors"],
    ...
    },
    {
        ...
        subCategories: ["All", "Chains", "Sprockets"],
    ...
    {
        id: "chain-pulley-blocks",
        name: "Chain Pulley Blocks",
        subCategories: ["All", "Hoists", "Pulley Blocks"],
        description: "Authorised dealership of Indef lifting and material handling equipment.",
        products: [
